...
execute as @r at @s if entity @s[scores={pillar_timer=1}] as @s run function bending:give_pillar

execute as @r at @s if entity @s[scores={tunnel_reset=1..}] as @s run function bending:tunnel

execute as @r at @s if entity @s[scores={dig_timer=1..}] run scoreboard players remove @s dig_timer 1
execute as @r at @s if entity @s[scores={dig_timer=0}] as @s run function bending:give_dig
