...
execute if entity @s[scores={tunnel_timer=1..}] at @s run fill ~1 ~2 ~1 ~-1 ~ ~-1 air replace #rocks
execute if entity @s[scores={tunnel_reset=1}] as @s run function bending:give_tunnel